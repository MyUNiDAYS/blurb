...
namespace Blurb.Core.Test
{
	public static class ShouldExtensions
	{
		...
		public static void ShouldEqual<T>(this T self, T other)
		{
			Assert.Equal(other, self);
		}

		public static void ShouldEqual<T>(this T self, T other, IEqualityComparer<T> comparer)
		{
			Assert.Equal(other, self, comparer);
		}

		public static void ShouldNotEqual<T>(this T self, T other)
		{
			Assert.NotEqual(other, self);
		}

		public static void ShouldNotEqual<T>(this T self, T other, IEqualityComparer<T> comparer)
		{
		...
		public static void ShouldBeInRange(this DateTime self, DateTime other, TimeSpan difference)
		{
			self.ShouldBeInRange(other - difference, other + difference);
		}
	}
}